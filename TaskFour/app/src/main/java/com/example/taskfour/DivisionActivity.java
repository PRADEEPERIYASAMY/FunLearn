...
public class DivisionActivity extends AppCompatActivity {
    ...
    private void down(){
        try {
            ...
            View view = (DivisionActivity.this).getWindow().getCurrentFocus();

            if (view != null && view.getWindowToken() != null) {

                IBinder binder = view.getWindowToken();

                InputMethodManager imm = (InputMethodManager) (DivisionActivity.this).getSystemService( Context.INPUT_METHOD_SERVICE);
