...
public class ListFiles extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        fileList = loadFiles ();
        FilesAdapter filesAdapter = new FilesAdapter ( this,fileList,1 );
        ...
        info.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick( View v ) {
                mediaPlayer.start ();
                final AlertDialog.Builder builder = new AlertDialog.Builder ( ListFiles.this,R.style.CustomDialog );
                View view = LayoutInflater.from ( ListFiles.this ).inflate ( R.layout.about_dialog,null,false );
    ...
    private List<File> loadFiles() {
        ...
        File parentDir = new File ( getExternalFilesDir ( Environment.DIRECTORY_PICTURES )+File.separator+"Paint"  );
