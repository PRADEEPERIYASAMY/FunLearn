...
public class NumberFillup extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        setContentView ( R.layout.activity_number_fillup );
        ...
        submit.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick( View v ) {
                ...
                if (answer.getText ().toString ().equals ( String.valueOf ( (int)(first + second)/2 ) )){
                    ...
                    for (int i = 0;i<((int)(first+second)/20);i++){
                    ...
                    if (((int)(first+second)/20) != 10){
                        recyclerViewList.get ( ((int)(first+second)/20) ).setHasFixedSize ( true );
                        recyclerViewList.get ( ((int)(first+second)/20) ).setLayoutManager ( new GridLayoutManager ( getApplicationContext (),10 ) );
                        recyclerViewList.get ( ((int)(first+second)/20) ).setAdapter ( new WriteAdapter ( getApplicationContext (),(((first+second)/2)-(((int)(first+second)/20)*10)),index ) );
                    }
                    recyclerInvisible ();
                    recylcerVisibility ( ((int)(first+second)/20) );
                }
                else {
                    mediaPlayer3.start ();
    ...
    private void valueSetter(){
        ...
        first = firstNum.get ( (int) (Math.random ()*97) );
        second = first+2;
    }
