...
public class MultiplicationActivity extends AppCompatActivity {
    ...
    private void down(){
        try {
            ...
            View view = (MultiplicationActivity.this).getWindow().getCurrentFocus();

            if (view != null && view.getWindowToken() != null) {

                IBinder binder = view.getWindowToken();

                InputMethodManager imm = (InputMethodManager) (MultiplicationActivity.this).getSystemService( Context.INPUT_METHOD_SERVICE);
