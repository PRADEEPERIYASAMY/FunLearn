    ...
    protected void onCreate( final Bundle savedInstanceState ) {
            ...
            button.setOnClickListener ( new View.OnClickListener () {
                ...
                public void onClick( View v ) {
                    if (answer.getText ().toString ().length () < 3){
                        ...
                        View view = LayoutInflater.from ( AdditionActivity.this ).inflate ( R.layout.toast,null,false );
        ...
        info.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick( View v ) {
                ...
                View view = LayoutInflater.from ( AdditionActivity.this ).inflate ( R.layout.about_dialog,null,false );
