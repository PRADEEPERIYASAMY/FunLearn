...
public class SubtractionActivity extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
            ...
            button.setOnClickListener ( new View.OnClickListener () {
                ...
                public void onClick( View v ) {
                    if (answer.getText ().toString ().length () < 3){
                        ...
                        View view = LayoutInflater.from ( SubtractionActivity.this ).inflate ( R.layout.toast,null,false );
        ...
        info.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick( View v ) {
                mediaPlayer.start ();
                final AlertDialog.Builder builder = new AlertDialog.Builder ( SubtractionActivity.this,R.style.CustomDialog );
                View view = LayoutInflater.from ( SubtractionActivity.this ).inflate ( R.layout.about_dialog,null,false );

                Button close = view.findViewById ( R.id.info_close );
                TextView infoText = view.findViewById ( R.id.info_text );

                infoText.setText ( "Just subtract the given numbers, and enter the result in answer field. If the answer is correct corresponding result will be shown, else you will be asked to try again." );
    ...
    private void exit(){
        mediaPlayer.start ();
        final AlertDialog.Builder builder = new AlertDialog.Builder ( SubtractionActivity.this,R.style.CustomDialog );
        View view = LayoutInflater.from ( SubtractionActivity.this ).inflate ( R.layout.alphabet_write_dialog,null,false );
