...
public class SubtractionActivity extends AppCompatActivity {
    ...
    private void down(){
        try {
            ...
            View view = (SubtractionActivity.this).getWindow().getCurrentFocus();

            if (view != null && view.getWindowToken() != null) {

                IBinder binder = view.getWindowToken();

                InputMethodManager imm = (InputMethodManager) (SubtractionActivity.this).getSystemService( Context.INPUT_METHOD_SERVICE);
